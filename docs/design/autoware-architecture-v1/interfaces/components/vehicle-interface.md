...
This page describes the Vehicle Interface Component. Please refer to the [Vehicle Interface design document](../../components/vehicle/index.md) for high-level concepts and data flow.
...
| Door status            | `/vehicle/doors/status`                  | [autoware_adapi_msgs/msg/DoorStatusArray](https://github.com/autowarefoundation/autoware_adapi_msgs/blob/main/autoware_adapi_v1_msgs/vehicle/msg/DoorStatusArray.msg)         | Yes                                  | Current door status                                                     |
